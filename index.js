/* Url: https://repl.it/@jimboy3100/smartbotschangingnames
 Websocket: wss://smartbotschangingnames--jimboy3100.repl.co
...
require('dns').lookup(require('os').hostname(), function (err, add, fam) { logger.warn('Server side IP: '+add); })
        ...
        for (const entity of Object.values(this.viewportEntities)) {
            ...
            switch (type) {
                case 'virus':
                    ...
                    break
                case 'biggerPlayer':
                    isConditionMet = !entity.isVirus && !entity.isPellet && entity.mass > botMass * 1.15 && entity.name !== bots.newname
                    break
                case 'smallerPlayer':
                    isConditionMet = !entity.isVirus && !entity.isPellet && entity.mass < botMass * 2 * 1.30 && entity.mass > 100 && entity.name !== bots.newname
                    break
                case 'smallerPlayerFollow':
                    isConditionMet = !entity.isVirus && !entity.isPellet && entity.mass < botMass * 1.30 && entity.mass > 50 && entity.name !== bots.newname
                    break
                case 'bot':
                    isConditionMet = !entity.isVirus && !entity.isPellet && entity.mass > botMass * 1.30 && botMass > 90 && entity.name == bots.newname
                    break					
                case 'pellet':
                    isConditionMet = !entity.isVirus && entity.isPellet
                    break
